...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	public ClassPathXmlApplicationContext(
		...
		//初始化 资源模式解析 this.resourcePatternResolver = PathMatchingResourcePatternResolver类
		//并且解析parent（父）环境
		super(parent);

		//设置上下文内容的配置文件类
		//如果没有指定环境this.environment，默认为标准环境StandardEnvironment
		//并解析配置的占位符信息, 通过PropertySourcesPropertyResolver来处理占位符的信息值
